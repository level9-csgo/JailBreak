...
{
	name = "[CS:GO] Quests System - Last Alive", 
	author = "KoNLiG", 
...
public void OnLibraryAdded(const char[] name)
{
	...
	{
		g_QuestIndex = JB_CreateQuest("lastalive", "Last Alive", "Win {progress} Last Requests.", QuestType_Weekly, 50000, 25, 40);
	}
}

public void JB_OnLrEnd(int currentLr, const char[] lrName, int winner, int loser, bool aborted)
{
	if (winner != INVALID_LR_WINNER)
	{

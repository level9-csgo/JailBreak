...
public OnPluginStart()
{
	...
	CvarFramePenalty = CreateConVar("sm_realbhop_framepenalty", "0.900", "Sets the velocity penalty multiplier per frame the player jumped too late. (1.0 = no penalty)", FCVAR_NOTIFY, true, 0.0, false);
